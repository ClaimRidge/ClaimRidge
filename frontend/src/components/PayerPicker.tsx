...
import { Payer, PAYERS } from "@/data/payers";
...
export default function PayerPicker({
  ...
  const { grouped, total } = useMemo(() => {
    ...
    const groups: Record<string, Payer[]> = {};
          ...
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div>
              ...
              <p className="text-xs text-[#6b7280] mt-0.5">
                MENA/GCC insurance companies and regional TPAs
              </p>
            </div>
          </div>
          <button
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {payer.providerIdFormat && (
                              <p className="text-xs text-[#9ca3af] mt-1 font-mono">
                                Provider ID: {payer.providerIdFormat}
                              </p>
                            )}
                          </div>
                        </div>
