"""Doctor-side endpoints for joining a provider organisation via its org code.

Email-based invitations were removed from the prototype — they'll come back
with real email delivery in a future iteration. For now, doctors join by
entering their hospital's `org_code` and waiting for the admin to approve.
"""
